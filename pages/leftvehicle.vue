<template>
  <div id="app">
    ...
    -->
        <div
          class="relative flex flex-col flex-1 w-full max-w-xs pt-5 pb-4 bg-element-bright-blue"
        >
          <!--
      ...
      <div class="hidden md:flex md:flex-shrink-0">
        <div class="flex flex-col w-20">
          ...
          <div class="flex flex-col flex-1 h-0">
            ...
            <div class="flex flex-col self-center flex-1 w-20 overflow-y-auto">
                ...
                <div class="hidden sm:block">
                  <nav class="flex space-x-4" aria-label="Tabs">
                    ...
                    <a
                      ...
                      class="px-3 py-2 text-sm font-medium text-gray-500 rounded-md hover:text-gray-700"
                    >
                      Price & Conifgurations
                    </a>
                  </nav>
                </div>
              </div>
              <div
                class="flex flex-row justify-end w-full p-4 text-sm font-bold text-white bg-element-bright-blue bg-opacity-70"
              >
                <div class="flex pl-3">
                  <button
                    type="button"
                ...
                <div class="flex pl-3">Add New</div>
                <div class="flex pl-3">Standard View</div>
                <div class="flex pl-3">Export</div>
              </div>
