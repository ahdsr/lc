      ...
      -->
          <div class="absolute top-0 right-0 pt-2 -mr-12">
            <button
              ...
              class="flex w-10 h-10 ml-1 rounded-full focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white"
            >
      ...
      <div class="hidden md:flex md:flex-shrink-0">
        <div class="flex flex-col w-20">
          ...
          <div class="flex flex-col flex-1 h-0">
            ...
            <div class="flex flex-col flex-1 w-20 overflow-y-auto">
              <nav class="flex-1 px-2 py-4 space-y-1 bg-element-bright-blue">
                <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->
                <a
                  href="#"
                  class="flex px-2 py-2 text-xs font-medium text-white bg-gray-900 rounded-md group"
                >
                  <!--
                Heroicon name: outline/home
              ...
              -->
                ...
                <a
                  href="#"
                  class="flex px-2 py-2 text-sm font-medium text-gray-300 rounded-md hover:bg-gray-700 hover:text-white group"
                >
                  <!-- Heroicon name: outline/users -->
                ...
                <nuxt-link
                  to="/order-bmts"
                  class="flex items-center px-2 py-2 text-sm font-medium text-gray-300 truncate rounded-md hover:bg-gray-700 hover:text-white group"
                >
                  <!-- Heroicon name: outline/inbox -->
